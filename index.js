...
// Connect database and collections synchronously at file level for serverless cold-start efficiency
const db = client.db("drivefleet");
const carsCollection = db.collection("cars");
const bookingsCollection = db.collection("bookings");

// Ping connection asynchronously in background
...
// Seed database asynchronously in the background if empty
